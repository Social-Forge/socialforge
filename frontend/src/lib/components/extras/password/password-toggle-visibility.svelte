<script lang="ts">
	import { Toggle } from '$lib/components/extras/toggle';
	import EyeIcon from '@lucide/svelte/icons/eye';
	import EyeOffIcon from '@lucide/svelte/icons/eye-off';
	import { usePasswordToggleVisibility } from '$lib/components/extras/password/password.svelte.js';
	import type { PasswordToggleVisibilityProps } from '$lib/components/extras/password/types.js';
