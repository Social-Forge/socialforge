<script lang="ts">
	...
	import { usePasswordStrength } from '$lib/components/extras/password/password.svelte.js';
	import type { PasswordStrengthProps } from '$lib/components/extras/password/types.js';
