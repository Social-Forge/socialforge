<script lang="ts">
	...
	import type { TagsInputProps } from '$lib/components/extras/tags-input/types';
	import TagsInputTag from '$lib/components/extras/tags-input/tags-input-tag.svelte';
	import TagsInputSuggestion from '$lib/components/extras/tags-input/tags-input-suggestion.svelte';
