...
<script lang="ts">
	import CountrySelector from '$lib/components/extras/phone-input/country-selector.svelte';
	import { type PhoneInputProps } from '$lib/components/extras/phone-input';
