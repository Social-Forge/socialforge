<script lang="ts">
	import * as Popover from '$lib/components/extras/popover';
	import Button from '$lib/components/button.svelte';
	import * as Command from '$lib/components/extras/command';
	import { ScrollArea } from '$lib/components/extras/scroll-area';
	import CheckIcon from '@lucide/svelte/icons/check';
	import ChevronsUpDownIcon from '@lucide/svelte/icons/chevrons-up-down';
	import { cn } from '$lib/utils.js';
	import Flag from '$lib/components/extras/phone-input/flag.svelte';
