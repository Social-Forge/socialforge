<script lang="ts">
	...
	import { useFileDropZoneTrigger } from '$lib/components/extras/file-drop-zone/file-drop-zone.svelte.js';
	import { displaySize } from '$lib/components/extras/file-drop-zone/index.js';
	import type { FileDropZoneTriggerProps } from '$lib/components/extras/file-drop-zone/types.js';
