import Root from '$lib/components/extras/file-drop-zone/file-drop-zone.svelte';
import Trigger from '$lib/components/extras/file-drop-zone/file-drop-zone-trigger.svelte';
import Textarea from '$lib/components/extras/file-drop-zone/file-drop-zone-textarea.svelte';
import type { FileDropZoneRootProps, FileRejectedReason } from '$lib/components/extras/file-drop-zone/types';
