<script lang="ts">
	...
	import Input from '$lib/components/extras/ipv4address-input/ipv4address-input-input.svelte';
	import { safeParseIPv4Address } from '$lib/components/extras/ipv4address-input';
	import { isNumber } from '$lib/utils/is-number';
	import * as ipv4address from '$lib/utils/ipv4-address';
	import type { IPv4AddressInputProps } from '$lib/components/extras/ipv4address-input/types';

	let {
		separator = '$lib/components/extras/ipv4address-input',
		value = $bindable(null),
		placeholder,
		class: className,
		name,
