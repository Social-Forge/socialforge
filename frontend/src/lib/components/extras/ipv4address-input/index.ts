...
import IPv4AddressInput from '$lib/components/extras/ipv4address-input/ipv4address-input.svelte';
...
export type { IPv4AddressInputProps, IPv4AddressInputPropsWithoutHTML } from '$lib/components/extras/ipv4address-input/types';
