<script lang="ts">
	...
	import { useAnimation } from '$lib/components/extras/terminal/terminal.svelte.js';
	import type { TerminalAnimationProps } from '$lib/components/extras/terminal/types';
