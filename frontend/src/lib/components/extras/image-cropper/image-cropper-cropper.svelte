<script lang="ts">
	...
	import { useImageCropperCropper } from '$lib/components/extras/image-cropper/image-cropper.svelte.js';
	import type { ImageCropperCropperProps } from '$lib/components/extras/image-cropper/types.js';
