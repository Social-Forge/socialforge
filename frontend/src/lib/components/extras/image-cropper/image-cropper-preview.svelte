<script lang="ts">
	...
	import type { ImageCropperPreviewProps } from '$lib/components/extras/image-cropper/types';
	import { useImageCropperPreview } from '$lib/components/extras/image-cropper/image-cropper.svelte.js';
