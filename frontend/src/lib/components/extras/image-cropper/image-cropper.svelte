<script lang="ts">
	...
	import { useImageCropperRoot } from '$lib/components/extras/image-cropper/image-cropper.svelte.js';
	import type { ImageCropperRootProps } from '$lib/components/extras/image-cropper/types';
