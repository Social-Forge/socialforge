<script lang="ts" module>
	...
	import type { ButtonSize, ButtonVariant } from '$lib/components/extras/button';
...
<script lang="ts">
	...
	import { useSplitButtonRootCtx } from '$lib/components/extras/split-button/split-button.svelte.js';
