<script lang="ts">
	import type { EmojiPickerFooterProps } from '$lib/components/extras/emoji-picker/types';
	import { useEmojiPickerFooter } from '$lib/components/extras/emoji-picker/emoji-picker.svelte.js';
