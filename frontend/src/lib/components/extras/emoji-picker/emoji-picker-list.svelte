<script lang="ts">
	import * as Command from '$lib/components/extras/command';
	import { Command as CommandPrimitive } from 'bits-ui';
	import data, { type EmojiMartData } from '@emoji-mart/data';
	import * as casing from '$lib/utils/casing';
	import type { EmojiPickerListProps } from '$lib/components/extras/emoji-picker/types';
	import { makeValue, parseValue, useEmojiPickerList } from '$lib/components/extras/emoji-picker/emoji-picker.svelte.js';
