<script lang="ts">
	...
	import type { EmojiPickerRootProps } from '$lib/components/extras/emoji-picker/types';
	import { useEmojiPicker } from '$lib/components/extras/emoji-picker/emoji-picker.svelte.js';
