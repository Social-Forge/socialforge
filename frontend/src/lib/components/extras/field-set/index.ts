import Root from '$lib/components/extras/field-set/field-set.svelte';
import Content from '$lib/components/extras/field-set/field-set-content.svelte';
import Footer from '$lib/components/extras/field-set/field-set-footer.svelte';
import Title from '$lib/components/extras/field-set/field-set-title.svelte';
import type {
	FieldSetRootProps,
	FieldSetTitleProps,
	FieldSetContentProps,
	FieldSetFooterProps
} from '$lib/components/extras/field-set/types';
