<script lang="ts">
	...
	import { codeVariants } from '$lib/components/extras/code';
	import type { CodeRootProps } from '$lib/components/extras/code/types';
	import { useCode } from '$lib/components/extras/code/code.svelte.js';
