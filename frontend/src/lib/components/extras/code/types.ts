...
import type { CodeVariant } from '$lib/components/extras/code';
import type { SupportedLanguage } from '$lib/components/extras/code/shiki';
import type { HTMLAttributes } from 'svelte/elements';
import type { CopyButtonPropsWithoutHTML } from '$lib/components/extras/copy-button/copy-button.svelte';
