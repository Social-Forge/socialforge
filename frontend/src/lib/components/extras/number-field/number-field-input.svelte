<script lang="ts">
	...
	import { useNumberFieldInput } from '$lib/components/extras/number-field/number-field.svelte.js';
	import type { NumberFieldInputProps } from '$lib/components/extras/number-field/types.js';
