<script lang="ts">
	...
	import { useNumberFieldButton } from '$lib/components/extras/number-field/number-field.svelte.js';
	import type { NumberFieldButtonProps } from '$lib/components/extras/number-field/types.js';
