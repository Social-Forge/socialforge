<script lang="ts" module>
	...
	export { type ButtonSize, type ButtonVariant } from '$lib/components/extras/button';
</script>

<script lang="ts">
	import { Button, type ButtonProps as ButtonPrimitiveProps } from '$lib/components/extras/button';
	import { Spinner } from '$lib/components/extras/spinner';
